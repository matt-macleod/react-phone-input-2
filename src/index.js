...
class ReactPhoneInput extends React.Component {
  ...
  constructor(props) {
    ...
    const preferredCountries = filter(
      filteredCountries,
      (country) => {
    ...
    const countryGuessIndex = findIndex(
      this.allCountries,
      countryGuess,
    );
    const dialCode =
  ...
  scrollTo = (country, middle) => {
    ...
    const containerTop =
      containerOffset.top + document.body.scrollTop;
  ...
  handleFlagDropdownClick = () => {
    ...
    if (
      this.state.preferredCountries.includes(
          ...
          >
            ...
            <span className="country-name">
              {this.props.localization[country.name] != undefined
                ? this.props.localization[country.name]
                : country.name}
            </span>
